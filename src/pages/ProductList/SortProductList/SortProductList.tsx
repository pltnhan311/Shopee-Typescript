...
export default function SortProductList({ queryConfig, pageSize }: Props) {
  // handle which action is actived
    ...
    <div className='bg-gray-300/40 px-3 py-4'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <button
            className={classNames('h-8 bg-rose-400 px-4 text-center text-sm capitalize rounded-sm', {
              'bg-rose-500 text-white hover:bg-rose-700': isActiveSortBy(sortBy.view),
          ...
          <button
            className={classNames('h-8 bg-rose-400 px-4 text-center text-sm capitalize rounded-sm', {
              'bg-rose-500 text-white hover:bg-rose-700': isActiveSortBy(sortBy.createdAt),
          ...
          <button
            className={classNames('h-8 bg-rose-400 px-4 text-center text-sm capitalize rounded-sm', {
              'bg-rose-500 text-white hover:bg-rose-700': isActiveSortBy(sortBy.sold),
          ...
          <select
            className={classNames('h-8 px-4 text-left text-sm capitalize outline-none rounded-sm', {
              'bg-rose-400 text-white hover:bg-rose-500': isActiveSortBy(sortBy.price),
